...
##Troisieme niveau de menu
  ...
  tkadd(PecheTemporelle,"command",label="Période 1 vs Période 2", command = T1_T2_Peche.f)
  tkadd(PecheTemporelle,"command",label="Période 1 vs Période 2 vs Période 3", command = T1_T2_T3_Peche.f)  
  ...
  tkadd(ConservationTemporelle,"command",label="Période 1 vs Période 2", command = T1_T2_Conservation.f)
  tkadd(ConservationTemporelle,"command",label="Période 1 vs Période 2 vs Période 3", command = T1_T2_T3_Conservation.f)  
